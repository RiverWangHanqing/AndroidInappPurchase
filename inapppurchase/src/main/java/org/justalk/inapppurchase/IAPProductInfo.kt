...
class IAPProductInfo(
    ...
    override fun toString(): String {
        return "IAPProductInfo(productType=${productType}, productId='$productId', formattedPrice='$formattedPrice', amountMicros=$amountMicros, currencyCode='$currencyCode', introductoryPrice='$introductoryPrice', freeTrial=$freeTrial)"
    }
}